// Write a java program that allows you to keep acessing an array until a valid index is given by the user. 

import java.util.Scanner;

public class QuickQize4 {
    public static void main(String[] args) {
        ...
        System.out.println("Thanks, Your programme is sucessfully execute.");
        input.close();
    }
}
